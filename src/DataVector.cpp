...
DataVector::DataVector(const std::vector <double>& data, const std::string& name) : data(data), name(name) {}
DataVector::DataVector(const std::vector <double>& data, const char* name) : data(data), name(name) {}
